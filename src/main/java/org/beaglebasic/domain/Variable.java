...
public class Variable {
    ...
    public static final class VariableName {
        ...
        private final STObjects.BeagleBasicDataType dataType;

        public VariableName(
                @NotNull String varname,
                @NotNull STObjects.BeagleBasicDataType dataType)
        {
        ...
        public STObjects.BeagleBasicDataType getDataType() {
            return dataType;
        }
        ...
        if (isArray) {
            if (!variableName.varname.startsWith(UDF_PREFIX)) {
                ...
                throw new BeagleBasicSemanticError(
                        BeagleBasicSemanticError.ErrorCode.ARRAY_VARIABLE_CANNOT_STARTWITH_FN,
                        lineSupplier.get(),
