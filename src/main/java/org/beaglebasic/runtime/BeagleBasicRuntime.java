...
import static org.beaglebasic.parser.BeagleBasicIR.OpCode.DATA;
import static org.beaglebasic.parser.BeagleBasicIR.OpCode.FIELD_I;
import static org.beaglebasic.parser.BeagleBasicIR.OpCode.INPUT_VAR;
import static org.beaglebasic.parser.BeagleBasicIR.OpCode.INSTR0;
import static org.beaglebasic.parser.BeagleBasicIR.OpCode.LABEL;
import static org.beaglebasic.parser.BeagleBasicIR.OpCode.MIDDLR0;
import static org.beaglebasic.parser.BeagleBasicIR.OpCode.OPEN_FN_FN_0;
import static org.beaglebasic.parser.BeagleBasicIR.OpCode.OPEN_OM_AM_1;

public class BeagleBasicRuntime {
    ...
    private int getInstrNumForLabel(int id) {
        ...
        if (instrNum == -1) {
            throw new BeagleBasicInternalError("Failed to find instruction# for label: " + id);
        }
        return instrNum;
    }
    ...
    private int getInstrNumForLineNumber(int lineNumber) {
        ...
        if (instrNum == -1) {
            throw new BeagleBasicInternalError("Failed to find instruction# for line#: " + lineNumber);
        }
        return instrNum;
    }
    ...
    public void run() {
        ...
        while (!end && programCounter < numInstructions) {
            ...
            } catch (BeagleBasicRuntimeError e) {
                throw new BeagleBasicRuntimeError(e, instruction, ir.getCodeStreamFor(instruction));
            }
        }
    }
        ...
        switch (instruction.opCode) {
            ...
            case INSTR: {
                if (instr0.size() != 1 || instr0.get(0).opCode != INSTR0) {
                    throw new BeagleBasicInternalError("Bad/null instr0: " + instr0.get(0) + ", expected: " + INSTR0);
                }
            ...
            case MIDDLR: {
                if (instr0.size() != 1 || instr0.get(0).opCode != MIDDLR0) {
                    throw new BeagleBasicInternalError("Bad/null instr0: " + instr0.get(0) + ", expected: " + MIDDLR0);
                }
