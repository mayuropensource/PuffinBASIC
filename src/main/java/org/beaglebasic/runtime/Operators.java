...
import static org.beaglebasic.error.BeagleBasicRuntimeError.ErrorCode.DIVISION_BY_ZERO;
...
public class Operators {
    ...
    public static void logical(BeagleBasicSymbolTable symbolTable, Instruction instruction) {
        var opCode = instruction.opCode;
