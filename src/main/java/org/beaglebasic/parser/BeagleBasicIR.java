...
public class BeagleBasicIR {
    ...
    private final BeagleBasicSymbolTable symbolTable;
    private final List<Instruction> instructions;

    public BeagleBasicIR(CharStream in, BeagleBasicSymbolTable symbolTable) {
        this.in = in;
    ...
    public BeagleBasicSymbolTable getSymbolTable() {
        return symbolTable;
    }
